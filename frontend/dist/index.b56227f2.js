...
})({"4jAbc":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "0331889cb56227f2";
"use strict";
...
(function setupListeners() {
    ...
    getWeatherButton.addEventListener("click", ()=>{
        (0, _fetchWeather.fetchWeather)(userZipInput.value).then((fetchedWeather)=>{
            weatherData = fetchedWeather;
            (0, _displayWeather.displayWeather)(weatherData);
        }).catch((error)=>{
            (0, _handleErrors.handleErrors)(error);
            console.error("Oops! Error fetching weather data:", error);
        });
    });
})();

},{"./fetchWeather":"enI4e","./displayWeather":"3JN3B","./handleErrors":"7cxfp"}],"enI4e":[function(require,module,exports) {
/**
...
async function fetchWeather(userZip) {
    try {
        let response = await (0, _axiosDefault.default).get(`/.netlify/functions/apiCall`, {
            params: {
                userZip: userZip
            }
        });
        ...
        (0, _handleErrors.handleErrors)(err);
        throw err;
    }
}

},{"./handleErrors":"7cxfp","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7cxfp":[function(require,module,exports) {
/**
 * Centralized error handling function.
 * @param error - The error object to be handled.
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleErrors", ()=>handleErrors);
var _showErrorMessage = require("./showErrorMessage");
function handleErrors(error) {
    if (error instanceof Error) console.error("Oops, an error occurred:", error.message);
    else console.error("Oops, an unknown error occurred:", error);
    (0, _showErrorMessage.showErrorMessage)("error-message", "Oops, an error occurred. Please try again.", 3000);
}

},{"./showErrorMessage":"4O6kz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4O6kz":[function(require,module,exports) {
/**
...
},{"adfd9b103875c2dd":"4KbQu","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4KbQu":[function(require,module,exports) {
/*!
...
},{"8d7b0712b5ea2b3":"85z8U","603aed6e39afb648":"l2T6y"}],"85z8U":[function(require,module,exports) {
"use strict";
...
},{}],"l2T6y":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3JN3B":[function(require,module,exports) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4jAbc","lyZAL"], "lyZAL", "parcelRequire8fb7")

//# sourceMappingURL=index.b56227f2.js.map
